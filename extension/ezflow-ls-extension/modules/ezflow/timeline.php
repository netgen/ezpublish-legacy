...
$cacheKey = 0 + time();
$nodeResult["title_path"] = [["text" => "Timeline Preview"], ["text" => $node->attribute( 'name' )]];

$httpCharset = eZTextCodec::httpCharset();
$locale = eZLocale::instance();
$languageCode = $locale->httpLocaleCode();

$nodeResult['content_info']['persistent_variable']['extra_template_list'] = ['timeline.tpl'];
$nodeResult['content_info']['persistent_variable']['pagestyle_css_classes'] = ['yui-skin-sam', 'yui-skin-ezflow'];

$site = ['title' => $ini->variable( 'SiteSettings', 'SiteName' ), 'design' => $ini->variable( 'DesignSettings', 'SiteDesign' ), 'uri' => eZURI::instance( eZSys::requestURI() ), 'http_equiv' => ['Content-Type' => 'text/html; charset=' . $httpCharset, 'Content-language' => $languageCode]];
