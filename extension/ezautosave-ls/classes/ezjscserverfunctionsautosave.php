...
class ezjscServerFunctionsAutosave extends ezjscServerFunctions
{
    ...
    static public function saveDraft( $args )
    {
        ...
        $result = ['unvalidated-attributes' => [], 'stored-attributes' => [], 'valid' => true];
        ...
        if ( $contentObject->attribute( 'status' ) == eZContentObject::STATUS_ARCHIVED )
        {
            ...
            throw new InvalidArgumentException(
                ezpI18n::tr(
                    ...
                    null, ['%objectid' => $contentObject->attribute( 'id' )]
                )
            );
        }
        ...
        if  ( !$version instanceof eZContentObjectVersion )
        {
            ...
            throw new InvalidArgumentException(
                ezpI18n::tr(
                    ...
                    null, ['%versionr' => (int)$args[1], '%objectid' => $contentObject->attribute( 'id' )]
                )
            );
        }
                ...
                && $version->attribute( 'status' ) != eZContentObjectVersion::STATUS_INTERNAL_DRAFT )
        {
            ...
            throw new RuntimeException(
                ezpI18n::tr(
                    ...
                    null, ['%versionr' => $version->attribute( 'version' ), '%objectid' => $version->attribute( 'contentobject_id' )]
                )
            );
        }
        ...
        ezpEvent::getInstance()->notify(
            ...
            [$contentObject->attribute( 'id' ), $version->attribute( 'version' )]
        );
    ...
    static public function saveDraftPreview( $args )
    {
        ...
        {
            $siteaccessList = [eZINI::instance( 'site.ini' )->variable(
     ...
     */
    protected static function getSiteaccessList( mixed $locale, eZContentObject $object )
    {
