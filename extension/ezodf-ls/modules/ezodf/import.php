            ...
            if ( $file->store() )
            {
                ...
                else
                {
                    ...
                    eZContentBrowse::browse( $module,
                                             ['action_name' => 'OOPlace', 'description_template' => 'design:ezodf/browse_place.tpl', 'content' => [], 'from_page' => '/ezodf/import/', 'cancel_page' => '/ezodf/import/'] );
                    return;
                }
            }
            else
...
$Result['path'] = [['url' => '/ezodf/import/', 'text' => ezpI18n::tr( 'extension/ezodf', 'OpenOffice.org import' )]];
