...
class ezgmlLocationFilter
{
    ...
    function createSqlParts( $params )
    {
        ...
        $arccosine = $params['arccosine'] ?? $params[3] ?? false;
        $asCircle  = $params['distance_as_circle'] ?? $params[4] ?? false;
        ...
        return ['tables' => ', ezcontentobject_attribute, ezgmaplocation', 'joins' => $sqlWhere, 'columns' => $sqlSelect];
    }
}
?>
