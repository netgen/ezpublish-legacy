...
class ezsrTemplateOperators
{
    ...
    {
        return ['fetch_starrating_data', 'fetch_starrating_stats', 'fetch_by_starrating'];
    }
    ...
    {
        return ['fetch_starrating_data' => ['params' => ['type' => 'array', 'required' => true, 'default' => []]], 'fetch_starrating_stats' => ['object_id' => ['type' => 'integer', 'required' => true, 'default' => 0]], 'fetch_by_starrating' => ['params' => ['type' => 'array', 'required' => false, 'default' => []]]];
