...
class ezsrRatingFilter
{
    function createSqlParts( $params )
    {
        ...
        $leftJoin = $params['incl_not_rated'] ?? $params[0] ?? false;
        ...
        return ['tables' => $sqlFrom, 'joins' => $sqlWhere, 'columns' => ', AVG( ezstarrating.rating_average ) as rating,
                             SUM( ezstarrating.rating_count ) as rating_count', 'group_by' => 'GROUP BY ezcontentobject.id'];
    }
}
?>
