...
class ezsrServerFunctions extends ezjscServerFunctions
{
    ...
    {
        $ret = ['id' => 0, 'rated' => false, 'already_rated' => false, 'stats' => false];
        if ( !isset( $args[2] ) )
        ...
        $rateDataObj = ezsrRatingDataObject::create( ['contentobject_id' => $contentobjectAttribute->attribute('contentobject_id'), 'contentobject_attribute_id' =>  $ret['id'], 'rating' => $args[2]]);
        ...
        if ( !$proiorRating )
        {
            ...
            $ret['rated'] = true;
            $ret['stats'] = ['rating_count' => $avgRateObj->attribute('rating_count'), 'rating_average' => $avgRateObj->attribute('rating_average'), 'rounded_average' => $avgRateObj->attribute('rounded_average')];
        }
        return $ret;
    }
    ...
    public static function user_has_rated( $args )
    {
        ...
        $rateDataObj = ezsrRatingDataObject::create( ['contentobject_id' => $args[0], 'contentobject_attribute_id' =>  $args[1]]);
