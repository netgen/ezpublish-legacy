...
class ezsrRatingObjectTreeNode extends eZContentObjectTreeNode
{
    ...
    static function definition()
    {
        ...
        if ( $def === null )
        {
            ...
            $def['fields']['rating'] = ['name' => 'Rating', 'datatype' => 'integer', 'default' => 0, 'required' => false];
            $def['fields']['rating_count'] = ['name' => 'RatingCount', 'datatype' => 'integer', 'default' => 0, 'required' => false];
        }
        return $def;
    }
    ...
    static function makeObjectsArray( $array , $with_contentobject = true, array $propertiesOverride = \null, $lang = \null )
    {
        $retNodes = [];
        if ( !is_array( $array ) )
            return $retNodes;
