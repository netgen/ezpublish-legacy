...
{
    final public const DATA_TYPE_STRING = 'ezsrrating';
    ...
    */
    ...
    {
        parent::__construct( self::DATA_TYPE_STRING, ezpI18n::tr( 'extension/ezstarrating/datatype', 'Star Rating', 'Datatype name' ), ['serialize_supported' => true] );
    }
    ...
    */
    function objectAttributeContent( $contentObjectAttribute )
    {
        ...
        if ( $objectId && $attributeId )
        {
            ...
            {
                $ratingObj = ezsrRatingObject::create( ['contentobject_id' => $objectId, 'contentobject_attribute_id' => $attributeId] );
            }
        }
        return $ratingObj;
    }
