...
if( $module->isCurrentAction( 'Upload' ) )
{
    ...
    $data = htmlentities( str_replace( ["\r\n", "\r", "\n"], [""], (string) $templateOutput ) , ENT_QUOTES, $httpCharset );
    $id = md5( (string)random_int(0, mt_getrandmax()) . (string)microtime() );
...
else
{
    ...
    $Result['path'] = [['url' => false, 'text' => ezpI18n::tr( 'extension/ezmultiupload', 'Multiupload' )]];
}
