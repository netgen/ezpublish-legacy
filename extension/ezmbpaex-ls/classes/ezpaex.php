...
{
    final public const NOT_DEFINED = -1;
    ...
    {
        return ['fields' => ['contentobject_id' => ['name' => 'ContentObjectID', 'datatype' => 'integer', 'default' => 0, 'required' => true, 'foreign_class' => 'eZContentObject', 'foreign_attribute' => 'id', 'multiplicity' => '0..1'], 'passwordvalidationregexp' => ['name' => 'PasswordValidationRegexp', 'datatype' => 'string', 'default' => '', 'required' => false], 'passwordlifetime' => ['name' => 'PasswordLifeTime', 'datatype' => 'integer', 'default' => '', 'required' => false], 'expirationnotification' => ['name' => 'ExpirationNotification', 'datatype' => 'integer', 'default' => '', 'required' => false], 'password_last_updated' => ['name' => 'PasswordLastUpdated', 'datatype' => 'integer', 'default' => '', 'required' => false], 'updatechildren' => ['name' => 'UpdateChildren', 'datatype' => 'integer', 'default' => '0', 'required' => false], 'expirationnotification_sent' => ['name' => 'ExpirationNotificationSent', 'datatype' => 'integer', 'default' => '0', 'required' => false]], 'keys' => ['contentobject_id'], 'function_attributes' => ['contentobject' => 'contentObject', 'is_expired' => 'isExpired', 'is_user' => 'isUser', 'has_regexp' => 'hasRegexp', 'has_lifetime' => 'hasLifeTime', 'has_notification' => 'hasNotification', 'can_edit' => 'canEdit', 'is_updatechildrenpending' => 'isUpdateChildrenPending'], 'relations' => ['contentobject_id' => ['class' => 'ezcontentobject', 'field' => 'id']], 'class_name' => 'eZPaEx', 'name' => 'ezx_mbpaex'];
    }
	...
	static function create( $contentObjectID )
    {
        ...
        $row = ['contentobject_id' => $contentObjectID, 'passwordvalidationregexp' => $iniPasswordValidationRegexp, 'passwordlifetime' => $iniDefaultPasswordLifeTime, 'expirationnotification' => $iniExpirationNotification, 'password_last_updated' => 0, 'updatechildren' => self::NOT_DEFINED, 'expirationnotification_sent' => 0];
	...
	function isUser()
	{
		$ezpo = eZPersistentObject::fetchObject( eZContentObject::definition(),
                                                null,
                                                ['id' => $this->attribute('contentobject_id')],
                                                true );
	...
	*/
    function validatePassword( $password )
    {
        ...
        {
            $regexp = preg_replace( ['/(^\/)/', '/(\/$)/'], '', (string) $this->attribute( 'passwordvalidationregexp' ) );
    ...
    */
        ...
        if ( !$currentPaex instanceof eZPaEx )
        {
            ...
            if ( $checkIfUserHasDatatype )
            {
                ...
                $paexDataTypeCount = eZPersistentObject::count( eZContentObjectAttribute::definition(),
                                                ['contentobject_id' => $ezcoid, 'data_type_string' => ezpaextype::DATA_TYPE_STRING],
                                                'id' );
     ...
     */
    function generateUpdateChildren( $paexToUpdate = [] )
    {
        ...
        else
        {
            ...
            $fullSubtree = eZContentObjectTreeNode::subTreeByNodeID( ["MainNodeOnly" => false, "AsObject" => false],
                                                                    $mainNodeID );
    ...
    */
    ...
    {
        $currentTime = time();
        $conds = ['expirationnotification_sent' => 0, 'passwordlifetime' => ['>', 0]];
