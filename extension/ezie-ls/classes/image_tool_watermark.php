...
class eZIEImageToolWatermark extends eZIEImageAction
{
    ...
    public static function filter( $region, $image )
    {
        ...
        $img_path = realpath( __DIR__ . "/../design/standard/images/watermarks" ) . "/" . $image;
        ...
        return [new ezcImageFilter(
            'watermarkAbsolute',
            ['image'  => $img_path, 'posX'   => $region['x'], 'posY'   => $region['y'], 'width'  => intval( $region['w'] ), 'height' => intval( $region['h'] )]
        )];
    }
}
?>