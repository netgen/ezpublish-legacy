...
{
    private readonly \ezcImageConverter $converter;
    ...
    */
    public function __construct( $filter )
    {
        ...
        if ( $hasImageMagick )
        {
            ...
            $settings = new ezcImageConverterSettings( [$imageHandlerSettings] );
        }
        else
        {
            $settings = new ezcImageConverterSettings( [new ezcImageHandlerSettings( 'GD', 'eZIEEzcGDHandler' )] );
        }
