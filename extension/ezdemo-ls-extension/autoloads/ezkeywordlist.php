...
class eZKeywordList
{
    ...
    {
        return ['ezkeywordlist' => ['class_identifier' => ['type'     => 'mixed', 'required' => true, 'default'  => ''], 'parent_node_id'   => ['type'     => 'integer', 'required' => true, 'default'  => 0], 'depth'            => ['type'     => 'integer', 'required' => false, 'default'  => 0]]];
    }
