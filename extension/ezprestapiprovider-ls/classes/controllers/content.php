...
class ezpRestContentController extends ezpRestMvcController
{
     ...
     * @var string
     */
    final public const VIEWCONTENT_RESPONSEGROUP_METADATA = 'Metadata',
     ...
     * @var string
     */
    final public const VIEWFIELDS_RESPONSEGROUP_FIELDVALUES = 'FieldValues',
     ...
     * @var string
     */
    final public const VIEWLIST_RESPONSEGROUP_METADATA = 'Metadata',
    ...
    {
        $content = null;
        $this->setDefaultResponseGroups( [self::VIEWCONTENT_RESPONSEGROUP_METADATA] );
    ...
    {
        $content = null;
        $this->setDefaultResponseGroups( [self::VIEWFIELDS_RESPONSEGROUP_FIELDVALUES] );
    ...
    {
        $this->setDefaultResponseGroups( [self::VIEWLIST_RESPONSEGROUP_METADATA] );
        $result = new ezpRestMvcResult();
        ...
        {
            $linkURI = $this->getRouter()->generateUrl( 'ezpNode', ['nodeId' => $result->variables['childrenNodes'][$i]['nodeId']] );
        ...
        if ( $this->hasResponseGroup( self::VIEWLIST_RESPONSEGROUP_METADATA ) )
        {
            ...
            $result->variables['metadata'] = ['childrenCount' => $childrenCount, 'parentNodeId'  => $this->nodeId];
