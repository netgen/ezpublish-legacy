...
class ezpRestContentServiceModelTest extends ezpDatabaseTestCase
{
    ...
    public function testGetMetadataByContent()
    {
        ...
        $expectedKeys = ['objectName', 'classIdentifier', 'datePublished', 'dateModified', 'objectRemoteId', 'objectId'];
    ...
    public function testGetMetadataByLocation()
    {
        ...
        $expectedKeys = ['nodeId', 'nodeRemoteId', 'fullUrl'];
    ...
    {
        $content = ezpContent::fromNodeId( 2 );
        $expectedKeys = ['type', 'identifier', 'value', 'id', 'classattribute_id'];
    ...
    public function requestObjectProvider()
    {
        ...
        $r1->contentVariables = ['Translation' => 'eng-GB', 'OutputFormat' => 'xhtml'];
