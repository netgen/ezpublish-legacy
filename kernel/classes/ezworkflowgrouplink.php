...
class eZWorkflowGroupLink extends eZPersistentObject
{
    ...
    {
        return ["fields" => ["workflow_id" => ['name' => "WorkflowID", 'datatype' => 'integer', 'default' => 0, 'required' => true, 'foreign_class' => 'eZWorkflow', 'foreign_attribute' => 'id', 'multiplicity' => '1..*'], "workflow_version" => ['name' => "WorkflowVersion", 'datatype' => 'integer', 'default' => 0, 'required' => true], "group_id" => ['name' => "GroupID", 'datatype' => 'integer', 'default' => 0, 'required' => true, 'foreign_class' => 'eZWorkflowGroup', 'foreign_attribute' => 'id', 'multiplicity' => '1..*'], "group_name" => ['name' => "GroupName", 'datatype' => 'string', 'default' => '', 'required' => true]], "keys" => ["workflow_id", "workflow_version", "group_id"], "class_name" => "eZWorkflowGroupLink", "sort" => ["workflow_id" => "asc"], "name" => "ezworkflow_group_link"];
    }

    static function create( $workflow_id, $workflow_version, $group_id, $group_name )
    {
        $row = ["workflow_id" => $workflow_id, "workflow_version" => $workflow_version, "group_id" => $group_id, "group_name" => $group_name];
    ...
    static function removeByID( $workflow_id, $workflow_version, $group_id )
    {
        eZPersistentObject::removeObject( eZWorkflowGroupLink::definition(),
                                          ["workflow_id" => $workflow_id, "workflow_version" =>$workflow_version, "group_id" => $group_id] );
    }
    ...
    static function fetchWorkflowList( $workflow_version, $group_id, $asObject = true )
    {
        return eZPersistentObject::fetchObjectList( eZWorkflowGroupLink::definition(),
                                                    null,
                                                    ["workflow_version" =>$workflow_version, "group_id" => $group_id],
                                                    null,
                                                    null,
                                                    $asObject);
    }
