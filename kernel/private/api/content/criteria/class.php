 ...
 * @package API
 */
class ezpContentClassCriteria implements ezpContentCriteriaInterface, \Stringable
{
    /**
    ...
    {
        return ['type' => 'param', 'name' => ['ClassFilterType', 'ClassFilterArray'], 'value' => ['include', $this->classes]];
    }
    ...
    public function __toString(): string
    {
        ...
        elseif ( count( $this->classes ) == 1 )
            return (string) "Content class is {$this->classes[0]}";
        else
