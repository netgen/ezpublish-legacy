...
class eZStepData
{
    ...
    */
    ...
    public $StepTable = [
        ['file' => 'welcome', 'class' => 'Welcome'],
        ['file' => 'system_check', 'class' => 'SystemCheck'],
        ['file' => 'system_finetune', 'class' => 'SystemFinetune'],
        ['file' => 'email_settings', 'class' => 'EmailSettings'],
        ['file' => 'database_choice', 'class' => 'DatabaseChoice'],
        ['file' => 'database_init', 'class' => 'DatabaseInit'],
        ['file' => 'language_options', 'class' => 'LanguageOptions'],
        ['file' => 'site_types', 'class' => 'SiteTypes'],
        // array( 'file' => 'site_packages',
        //        'class' => 'SitePackages' ),
        ['file' => 'package_language_options', 'class' => 'PackageLanguageOptions'],
        ['file' => 'site_access', 'class' => 'SiteAccess'],
        ['file' => 'site_details', 'class' => 'SiteDetails'],
        ['file' => 'site_admin', 'class' => 'SiteAdmin'],
        ['file' => 'security', 'class' => 'Security'],
        ['file' => 'registration', 'class' => 'Registration'],
        ['file' => 'create_sites', 'class' => 'CreateSites', 'count_step' => false],
        ['file' => 'final', 'class' => 'Final'],
    ];
