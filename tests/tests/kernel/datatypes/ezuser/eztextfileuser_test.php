<?php
/**
 * File containing the eZTextFileUserTest class.
 *
...
class eZTextFileUserTest extends ezpDatabaseTestCase
{
    ...
    public function setUp()
    {
        ...
        ezpINIHelper::setINISetting( 'textfile.ini', 'TextFileSettings', 'FilePath', __DIR__ . DIRECTORY_SEPARATOR . 'data' );
    ...
    public function testLoginCorrect()
    {
        ...
        static::assertEquals(true, $user instanceof eZUser);

        // check that the name doesn't contain new line at the end
        $userObject = eZContentObject::fetch( $user->ContentObjectID );
        static::assertEquals($this->firstname . ' ' . $this->lastname, $userObject->Name);
    }
    ...
    public function testLoginWrongPassword()
    {
        ...
        static::assertEquals(false, $user instanceof eZUser);
    }
