...
<p>
 {"Your PHP does not have support for all databases that eZ Publish supports."|i18n("design/standard/setup/tests")}
 {"Although eZ Publish will work without it, you might later want to have support for this database prepared."|i18n("design/standard/setup/tests")}
